export class Page {
  ...
  private get loginHeadButton(): ChainablePromiseElement<WebdriverIO.Element> {
    return $('selector-for-login-head-button');
}
...
public async clickLoginHeadButton(): Promise<void> {
    await this.loginHeadButton.click();
}
...
public async login(username: string, password: string): Promise<void> {
    await this.clickLoginHeadButton();
