import { Given, When, Then } from '@cucumber/cucumber'; // Adjust as per your testing framework
import { expect } from 'chai'; // Assuming you use Chai for assertions
import { Page } from '../../page-objects/page'; // Adjust the path to your Page class
