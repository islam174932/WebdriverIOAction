...
export const config: Options.Testrunner = {
  ...
  reporters: [
    ...
    ['video', {
      saveAllVideos: true,                // Save videos for all test cases
      videoSlowdownMultiplier: 3,         // Slower videos (for easier viewing)
      outputDir: join(__dirname, 'reports/videos'),  // Output directory for videos
    }],
  ],
