...
export const config: Options.Testrunner = {
  ...
  capabilities: [{
    ...
    browserName: 'chrome',
    'goog:chromeOptions': {
        binary: 'C:\\Users\\User\\Desktop\\mychrome\\chrome.exe', // Path to your Chrome executable
        args: [
            '--disable-gpu',
...
path: 'C:\\Users\\User\\Desktop\\mychrome\\chromedriver.exe', // Path to your ChromeDriver executable
