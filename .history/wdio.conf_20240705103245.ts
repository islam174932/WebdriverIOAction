...
import { VideoRecorder } from './video-recorder'; // Adjust path as necessary

// Initialize dotenv configuration
dotenv.config();

// Define videoRecorder variable
...
export const config: Options.Testrunner = {
  ...
  before: function (capabilities, specs) {
    const testName = specs[0]; // Adjust if you have multiple specs
